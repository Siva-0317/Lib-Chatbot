# === Library Bot Script with Whisper Speech Recognition and Hyperlink Support ===
...
WHISPER_MODEL_SIZE = "medium"  # or "small", "medium", "large-v2"
...
class LibraryBotGUI:
    ...
    def handle_speech(self):
        while self.recording:
            ...
            if mode == "Search":
                ...
                self.insert_with_links(f"Bot: {response}\n")
                speak(response)
    ...
    def insert_with_links(self, text):
        ...
        for match in re.finditer(url_regex, text):
            ...
            self.text_area.tag_config(tag, foreground="blue", underline=1)
